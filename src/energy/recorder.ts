...
export const getStatisticIds = (hass: HomeAssistant, statistic_type?: 'mean' | 'sum') =>
...
export const updateStatisticsMetadata = (hass: HomeAssistant, statistic_id: string, unit_of_measurement: string | null) =>
  hass.callWS<void>({
...
export const calculateStatisticSumGrowth = (values: StatisticValue[]): number | null => {
...
export const calculateStatisticsSumGrowth = (data: Statistics, stats: string[]): number | null => {
...
export const statisticsHaveType = (stats: StatisticValue[], type: StatisticType) => stats.some(stat => stat[type] !== null);

const mean_stat_types: readonly StatisticType[] = ['mean', 'min', 'max'];
const sum_stat_types: readonly StatisticType[] = ['sum'];

export const statisticsMetaHasType = (metadata: StatisticsMetaData, type: StatisticType) => {
...
export const getStatisticLabel = (hass: HomeAssistant, statisticsId: string, statisticsMetaData: StatisticsMetaData | undefined): string => {
